...
Plugin 'https://github.com/lkdjiin/vim-foldcomments.git'
Plugin 'https://github.com/tpope/vim-fugitive.git'
Plugin 'https://github.com/tpope/vim-repeat.git'
Plugin 'https://github.com/lkdjiin/vim-surround.git'
Plugin 'https://github.com/Lokaltog/vim-easymotion.git'
Plugin 'https://github.com/junegunn/vader.vim.git'
Plugin 'https://github.com/t9md/vim-choosewin.git'
Plugin 'https://github.com/MattesGroeger/vim-bookmarks.git'
Plugin 'https://github.com/airblade/vim-gitgutter.git'
Plugin 'https://github.com/godlygeek/tabular.git'
Plugin 'https://github.com/emilsoman/spec-outline.vim.git'
...
Plugin 'https://github.com/JuliaLang/julia-vim.git'
Plugin 'https://github.com/raichoo/haskell-vim.git'
Plugin 'https://github.com/matze/vim-markdown.git'
